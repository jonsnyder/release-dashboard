...
export function UnreleasedChanges({ unreleasedPRs, openPRs, parsedReleaseNotes }: UnreleasedChangesProps) {
  return (
    <View>
      <Heading level={2}>Unreleased Changes ({unreleasedPRs.length} PRs)</Heading>
      <Divider />
      ...
      <Flex direction="column" gap="size-400">
        ...
        {unreleasedPRs.length === 0 ? (
          <Text>No unreleased changes since the last stable release.</Text>
        ) : parsedReleaseNotes ? (
          <Flex direction="column" gap="size-400">
